...
public class UnpickedState : State<TimelessKey, TimelessKey.State>
{
    public UnpickedState(TimelessKey entity, TimelessKey.State stateEnum) : base(entity, stateEnum)
    {
    }
