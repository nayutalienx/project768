...
using project768.scripts.game_entity.landscape.timeless_cloud_platform;
using project768.scripts.state_machine;


public partial class TimelessCloudPlatform : AnimatableBody2D,
    ISpawnable,
    IStateMachineEntity<TimelessCloudPlatform, TimelessCloudPlatform.State>
{
    ...
    public State<TimelessCloudPlatform, State> CurrentState { get; set; }
    public Dictionary<State, State<TimelessCloudPlatform, State>> States { get; set; }
    ...
    public override void _Ready()
    {
        ...
        StateChanger = new StateChanger<TimelessCloudPlatform, State>(this);
